    ...
    <div className="w-full h-screen bg-gray-200 flex items-center justify-center">
      ...
      <div className="w-1/4 h-5/6 bg-gray-800">
        ...
        <div className="w-full mt-5 flex flex-wrap items-center justify-center">
          ...
          <div onClick= {clear} className="m-2 w-14 h-14 text-white text-2xl flex items-center justify-center bg-blue-400 rounded-full">AC</div>
          <div className="m-2 w-14 h-14 text-white text-2xl flex items-center justify-center bg-blue-400 rounded-full">+/-</div>
          <div onClick= {percentage} className="m-2 w-14 h-14 text-white text-2xl flex items-center justify-center bg-blue-400 rounded-full">%</div>
